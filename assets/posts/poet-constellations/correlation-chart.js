(function() {
  ...
  **/
  ...
  var updateChart = function(data) {
    ...
    var selection = d3.select('.' + cells.container).selectAll('rect')
  ...
  **/
  ...
  function getDatafilePath() {
    ...
    // identify the current values of the selectors
    ...
    var dir = '/assets/posts/poet-constellations/json/cooccurrence_data/';
  ...
  **/
  ...
  d3.json(getDatafilePath(), function(data) {
  ...
  **/
  ...
  // add event listeners
  var selects = document.querySelectorAll('.correlation-chart-selects');
