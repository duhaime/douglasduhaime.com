...
js: /assets/posts/crud-operations/js/crud-operations.js
css: /assets/posts/crud-operations/css/crud-operations.css
---

{% capture img_dir %}{{ site.baseurl }}/assets/posts/crud-operations/images{% endcapture %}
...
<div class='ghost-container'>
  ...
  <div id='loader'>{% include loader.html %}</div>
  <div class='ghost'></div>
</div>
...
<img class='medium' src='{{ img_dir }}/google-sheet-template.png' alt='Google Sheets template in which data sent through POST requests will be kept'>
...
<img class='center-image medium' src='{{ img_dir }}/completed-form.png' alt='Google Sheet with data received from POST request'>
