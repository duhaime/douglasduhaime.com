...
{% capture img_dir %}{{ site.baseurl }}/assets/posts/classifying-shakespeare/images{% endcapture %}
...
<img class='large' src='{{ img_dir }}/tempest.png' alt='Visualization of the number of characters on stage throughout The Tempest.'>
...
<img class='large' src='{{ img_dir }}/chars_on_stage_all.png' alt='Visualization of the number of characters on stage throughout each Shakespearean play.'>
...
<div id='trio-a' class='inline-trio'></div>
...
<img class='large' src='{{ img_dir }}/means_by_genre.png' alt='Mean character-on-stage counts by genre.'>
...
<div id='trio-b' class='inline-trio'></div>
...
<img class='large' src='{{ img_dir }}/female_presence_vs_length.png' alt='Visualization of the percent of lines spoken by women and play length of each Shakespearean play.'>
