...
js:
  ...
  - /assets/posts/similar-images/js/similar-images.js
---
...
<a href='{{ site.baseurl }}/pages/tsne-images/index.html' class='click-to-interact'>
  <img src='{{ site.baseurl }}/assets/posts/similar-images/images/tsne-images.jpg' alt='TSNE projection of similar images from the New York Public Library collection of Works Progress Administration photos'>
</a>
