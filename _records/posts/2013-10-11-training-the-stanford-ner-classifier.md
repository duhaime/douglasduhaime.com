...
<img class='medium' src='{{ img_dir }}/true-positives.jpg' alt='Frequency of True Positive classification results after training the Stanford CoreNLP NER model.' />
...
<img class='medium' src='{{ img_dir }}/false-positives.jpg' alt='Frequency of False Positive classification results after training the Stanford CoreNLP NER model.' />
...
<img class='medium' src='{{ img_dir }}/false-negatives.jpg' alt='Frequency of False Negative classification results after training the Stanford CoreNLP NER model.' />
...
<img class='medium' src='{{ img_dir }}/true-negatives.jpg' alt='Frequency of True Negative classification results after training the Stanford CoreNLP NER model.' />
...
<img class='medium' src='{{ img_dir }}/precision.jpg' alt='Precision classification results after training the Stanford CoreNLP NER model.' />
...
<img class='medium' src='{{ img_dir }}/recall.jpg' alt='Recall classification results after training the Stanford CoreNLP NER model.' />
...
<img class='medium' src='{{ img_dir }}/f1.jpg' alt='F1 classification results after training the Stanford CoreNLP NER model.' />
