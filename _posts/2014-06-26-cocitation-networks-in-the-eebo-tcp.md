...
thumbnail: |
  /assets/posts/eebo-cocitation/eebo-cocitation-thumb.jpg
banner: |
  /assets/posts/eebo-cocitation/eebo-cocitation-banner.jpg
---
...
<img class='large' src='{{ site.baseurl }}/assets/posts/eebo-cocitation/sample_eebo_xml.jpg' alt='Sample quotation XML in the EEBO TCP.'>
...
<img class='large' src='{{ site.baseurl }}/assets/posts/eebo-cocitation/estc_eebo-tcp_titles.jpg' alt='EEBO TCP corpus size vs. full ESTC corpus size over time.'>
...
<img class='large' src='{{ site.baseurl }}/assets/posts/eebo-cocitation/eebo_bibl_top_forty.jpg' alt='Visualization of the forty most quoted sources in the EEBO TCP.'>
...
<img class='small' src='{{ site.baseurl }}/assets/posts/eebo-cocitation/simple_sample_network.png' alt='Network visualization of individuals commonly cited together in the EEBO TCP corpus.'>
...
<a href='{{ site.baseurl }}/assets/posts/eebo-cocitation/network' class='click-to-interact'>
  <img class='large' src='{{ site.baseurl }}/assets/posts/eebo-cocitation/eebo_cocitation.jpg' alt='Preview of an interactive page on which users can interact with a network visualization of EEBO TCP cocitations.'>
</a>
...
[eebo-cocitation-interactive]:{{ site.baseurl }}/assets/posts/eebo-cocitation/network/index.html