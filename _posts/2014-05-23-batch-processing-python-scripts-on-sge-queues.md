...
<img class='small' src='/assets/posts/batch-processing/iteration_schedule_map.png' alt='Sample N**2 SGE parameter matrix.'>
...
<img class='large' src='/assets/posts/batch-processing/prepared_for_batch_submission.png' alt='Screenshot showing all files required for batch processing on SGE.'>
...
<img class='large' src='/assets/posts/batch-processing/batch_sge_submission.png' alt='Screenshot showing command to submit batch processing command to the SGE cluster.'>
