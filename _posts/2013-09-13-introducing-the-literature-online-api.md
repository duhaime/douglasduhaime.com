...
<img class='center-image medium' src='/assets/posts/lion-api/lion-api-mac.png' alt='Screenshot of the Literature Online API GUI compiled with Tkinter.' />
...
<img class='center-image medium' src='/assets/posts/lion-api/lion-api-sample-output.jpg' alt='Screenshot of the spreadsheet generated by the Literature Online API.' />
...
<img class='center-image small' src='/assets/posts/lion-api/new-oxford-shakespeare.jpg' alt='Oxford University Press printing of authorship attribution work completed with Gary Taylor.'>
